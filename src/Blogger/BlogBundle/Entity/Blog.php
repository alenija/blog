...
//HasLifecycleCallbacks() - что бы срабатывал обработчики событий
// prePersist, preUpdate, postPersist, preUpdate
// при использовании аннотаций в Symfony 2 + Doctrine 2
...
class Blog
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Comment", mappedBy="blog", fetch="EXTRA_LAZY")
     */
    protected $comments;
